...
public class MatrixMultiplication_Mine {
	 ...
	 * 
	 * where i, j and k are indexes of given matrices. Also NOTE, matricess must
	 * be SQUARE or RECTANGLED matrices, and SATISFY below condition.
	 * 
