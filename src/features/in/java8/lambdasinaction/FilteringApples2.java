...
public class FilteringApples2 {
	...
	public static void main(String... args) {
		 ...
		 * name. But anonymous classes are still not good enough because they take a lot
		 * of space.
		 */
		// [Apple{color='red', weight=120}]
		...
		heavyApples = filter(inventory, (Apple a) -> a.getWeight() > 150);
		System.out.println(heavyApples);
		...
		//// Seventh approach - Method Reference
		greenApples = filter(inventory, FilteringApples2::isGreenApple);
		System.out.println(greenApples);

		heavyApples = filter(inventory, FilteringApples2::isHeavyApple);
		System.out.println(heavyApples);
