...
public class About {
	 ...
	 * CORBA, and Java FX have been removed from JDK. They will be available from
	 * Maven repositories. JavaScript Nashorn engine has been deprecated. Java
	 * applets have been removed for good.
	 * 
	 * <pre>
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Oracle stops Java 8 support from January 2019. You’ll need to pay for more support. Bugun January 20");
