...
public class NoMoreNashornOrOfRhino {

	public static void main(String[] args) {
		System.out.println("In Java 15 -- Nashorn JS Engine (old one was Rhino engine) – removed, also the tool ‘jjs’ is removed.  ");
		String info = 
				"\n Rhino is a JavaScript engine written fully in Java and managed by the Mozilla Foundation  as open source software. "
				+ "It is separate from the SpiderMonkey engine,"
						+ "\n SpiderMonkey is also developed by Mozilla, but written in C++ and used in Mozilla Firefox. "
						+ "\n V8â€Š- â€Šopen source, developed by Google, written in C++ used in Chrome. "
						+ "The main difference here is that V8 doesnâ€™t produce bytecode or any intermediate code"
						+ "\n Nashorn, open source as part of OpenJDK, written by Oracle Java Languages and Tool Group";

		String compare = "See comparison: https://ariya.io/2014/03/nashorn-the-new-rhino-on-the-block";

		String aboutRhino = 
				"\n\nOriginally, Rhino compiled all JavaScript code to Java bytecode in generated Java class files. "
				+ "This produced the best performance, often beating the C++ \n implementation of JavaScript run with just-in-time compilation (JIT), "
		 ...
		 * 
		 *Nashorn fully supports ECMAScript 5.1 specification along with some extensions, to 100% pure Java implementation and 100% 
		 *complied to bytecode and not the interpreted mode as with Rhino. 
		 *
		 *Unlike Rhino, which has its own JavaScript debugger, The Nashorn does not provide itâ€™s own JavaScript debugger but 
		 *it provides an ability to remotely debug applications using an IDE like Eclipse, IntelliJ IDEA.
		 * 
		 * 
		 * </pre>
		 * 
