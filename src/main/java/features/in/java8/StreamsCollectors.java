...
public class StreamsCollectors {
	...
	public static void main(String[] args) {
		...
		// What is a Stream ? A typed interface
		// helps to process large data in fast way
		...
		System.out.println("Just note that, Operator precedence is not WORKING for predicates");
