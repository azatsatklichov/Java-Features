...
//		Map<Set<String>, Set<Book2>> booksByAuthors = books.collect(groupingBy(Book2::getAuthors, filtering(b -> b.getPrice() > 10, toSet())));
...
//				.collect(groupingBy(Book2::getPrice, flatMapping(b -> b.getAuthors().stream(), toSet())));
