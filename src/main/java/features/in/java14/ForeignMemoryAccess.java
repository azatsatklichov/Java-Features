...
class NativeAllocations {
	 ...
	 * from the
	 * 
	 * native memory to maintain its class metadata, application code, the code
	 * generated by JIT, internal data structures, etc. In the following sections,
	 * we'll explore some of those allocations.
	 */
