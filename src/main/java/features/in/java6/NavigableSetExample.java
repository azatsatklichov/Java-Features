...
public class NavigableSetExample {
	public static void main(String[] args) {
		...
		// Viewing the portion of navigable set whose elements are strictly less than
		// the given element
		System.out.println("Navigable set whose elements are strictly less than '40': " + nSet.headSet(40));
		// Viewing the portion of navigable set whose elements are greater than or equal
		// to the given element
		System.out
				.println("Navigable set whose elements are greater than or equal to '40': " + nSet.tailSet(40) + "\n");
