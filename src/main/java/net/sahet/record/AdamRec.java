...
/**
 * We can also add constructors, and modify the canonical constructor (the one
 * that takes the two String parameters).
 *
 */
...
record ForSpecSemantic(String name) implements Runnable {
	...
	public String toString() {
		return "ForSpecSemantic {" + "name=" + name + '}';
	}

	public String myInstanceMethod() {
		return "EuroChampionships [[" + "name=" + name + "]]";
	}
