...
import com.joshcummings.cats.generated.DescendentsBenchmark2_BaselineState_jmhType;
import com.joshcummings.cats.generated.DescendentsBenchmark2_jmhType;
public final class DescendentsBenchmark2_baseline_jmhTest {
    ...
    public BenchmarkTaskResult baseline_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            DescendentsBenchmark2_BaselineState_jmhType l_baselinestate1_G = _jmh_tryInit_f_baselinestate1_G(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_descendentsbenchmark20_0.baseline(l_baselinestate1_G));
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            baseline_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_baselinestate1_G, l_descendentsbenchmark20_0);
    ...
    public static void baseline_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, DescendentsBenchmark2_BaselineState_jmhType l_baselinestate1_G, DescendentsBenchmark2_jmhType l_descendentsbenchmark20_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult baseline_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            baseline_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_baselinestate1_G, l_descendentsbenchmark20_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult baseline_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            baseline_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_baselinestate1_G, l_descendentsbenchmark20_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void baseline_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, DescendentsBenchmark2_BaselineState_jmhType l_baselinestate1_G, DescendentsBenchmark2_jmhType l_descendentsbenchmark20_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult baseline_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            baseline_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_baselinestate1_G, l_descendentsbenchmark20_0);
            control.preTearDown();
    ...
    public static void baseline_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, DescendentsBenchmark2_BaselineState_jmhType l_baselinestate1_G, DescendentsBenchmark2_jmhType l_descendentsbenchmark20_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile DescendentsBenchmark2_BaselineState_jmhType f_baselinestate1_G;
    
    DescendentsBenchmark2_BaselineState_jmhType _jmh_tryInit_f_baselinestate1_G(InfraControl control) throws Throwable {
        DescendentsBenchmark2_BaselineState_jmhType val = f_baselinestate1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = f_baselinestate1_G;
            if (val != null) {
                return val;
            }
            val = new DescendentsBenchmark2_BaselineState_jmhType();
            val.readyTrial = true;
            f_baselinestate1_G = val;
            } catch (Throwable t) {
