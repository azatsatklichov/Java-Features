...
public final class DescendentsBenchmark2_listCats_jmhTest {
    ...
    public BenchmarkTaskResult listCats_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            DescendentsBenchmark2_jmhType l_descendentsbenchmark20_0 = _jmh_tryInit_f_descendentsbenchmark20_0(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_descendentsbenchmark20_0.listCats(l_catservicestate1_G));
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            listCats_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_catservicestate1_G, l_descendentsbenchmark20_0);
            ...
            if (control.isLastIteration()) {
                ...
                f_descendentsbenchmark20_0 = null;
            }
    ...
    public BenchmarkTaskResult listCats_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            listCats_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_catservicestate1_G, l_descendentsbenchmark20_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void listCats_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, DescendentsBenchmark2_CatServiceState_jmhType l_catservicestate1_G, DescendentsBenchmark2_jmhType l_descendentsbenchmark20_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult listCats_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            listCats_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_catservicestate1_G, l_descendentsbenchmark20_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult listCats_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            listCats_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_catservicestate1_G, l_descendentsbenchmark20_0);
            control.preTearDown();
